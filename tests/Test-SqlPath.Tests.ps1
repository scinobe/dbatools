...
--------                            --------     --------   ----  -------                                                     
PSUseOutputTypeCorrectly            Information  Test-SqlPa 77    The cmdlet 'Test-SqlPath' returns an object of type         
                                                 th.ps1           'System.Boolean' but this type is not declared in the       
                                                                  OutputType attribute.                                       
PSUseOutputTypeCorrectly            Information  Test-SqlPa 81    The cmdlet 'Test-SqlPath' returns an object of type         
                                                 th.ps1           'System.Boolean' but this type is not declared in the       
                                                                  OutputType attribute.                                       
