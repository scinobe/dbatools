...
--------                            --------     --------   ----  -------                                                     
PSUseShouldProcessForStateChangingF Warning      Update-Sql 1     Function ’Update-SqlWhoIsActive’ has verb that could change 
unctions                                         WhoIsActiv       system state. Therefore, the function has to support        
                                                 e.ps1            'ShouldProcess'.                                            
PSAvoidUsingPlainTextForPassword    Warning      Update-Sql 75    Parameter '$SqlCredential' should use SecureString,         
                                                 WhoIsActiv       otherwise this will expose sensitive information. See       
                                                 e.ps1            ConvertTo-SecureString for more information.    

Logged as issue #388, take a look there for more detail.
