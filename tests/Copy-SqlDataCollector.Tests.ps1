...
--------                            --------     --------   ----  -------                                                     
PSPossibleIncorrectComparisonWithNu Warning      Copy-SqlDa 100   $null should be on the left side of equality comparisons.   
ll                                               taCollecto                                                                   
                                                 r.ps1                                                                        
PSPossibleIncorrectComparisonWithNu Warning      Copy-SqlDa 169   $null should be on the left side of equality comparisons.   
ll                                               taCollecto                                                                   
                                                 r.ps1                                                                        
