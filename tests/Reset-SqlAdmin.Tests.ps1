...
--------                            --------     --------   ----  -------                                                     
PSPossibleIncorrectComparisonWithNu Warning      Reset-SqlA 222   $null should be on the left side of equality comparisons.   
ll                                               dmin.ps1                                                                     
PSPossibleIncorrectComparisonWithNu Warning      Reset-SqlA 277   $null should be on the left side of equality comparisons.   
ll                                               dmin.ps1                                                                     
PSPossibleIncorrectComparisonWithNu Warning      Reset-SqlA 298   $null should be on the left side of equality comparisons.   
ll                                               dmin.ps1                                                                     
PSPossibleIncorrectComparisonWithNu Warning      Reset-SqlA 316   $null should be on the left side of equality comparisons.   
ll                                               dmin.ps1                                                                     
PSAvoidUsingWMICmdlet               Warning      Reset-SqlA 221   File 'Reset-SqlAdmin.ps1' uses WMI cmdlet. For PowerShell   
                                                 dmin.ps1         3.0 and above, use CIM cmdlet which perform the same tasks  
...
PSAvoidUsingWMICmdlet               Warning      Reset-SqlA 318   File 'Reset-SqlAdmin.ps1' uses WMI cmdlet. For PowerShell   
                                                 dmin.ps1         3.0 and above, use CIM cmdlet which perform the same tasks  
                                                                  as the WMI cmdlets. The CIM cmdlets comply with             
                                                                  WS-Management (WSMan) standards and with the Common         
                                                                  Information Model (CIM) standard, which enables the cmdlets 
                                                                  to use the same techniques to manage Windows computers and  
                                                                  those running other operating systems.                      
PSAvoidUsingCmdletAliases           Warning      Reset-SqlA 211   'Select' is an alias of 'Select-Object'. Alias can          
                                                 dmin.ps1         introduce possible problems and make scripts hard to        
