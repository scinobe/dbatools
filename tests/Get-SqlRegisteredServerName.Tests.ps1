...
--------                            --------     --------   ----  -------                                                     
PSUseOutputTypeCorrectly            Information  Get-SqlReg 186   The cmdlet 'Get-SqlRegisteredServerName' returns an object  
                                                 isteredSer       of type 'System.Object[]' but this type is not declared in  
                                                 verName.ps       the OutputType attribute.                                   
                                                 1                                                                            
PSAvoidUsingPlainTextForPassword    Warning      Get-SqlReg 76    Parameter '$SqlCredential' should use SecureString,         
                                                 isteredSer       otherwise this will expose sensitive information. See       
                                                 verName.ps       ConvertTo-SecureString for more information.                
                                                 1                                                                            
PSAvoidUsingWMICmdlet               Warning      Get-SqlReg 165   File 'Get-SqlRegisteredServerName.ps1' uses WMI cmdlet. For 
                                                 isteredSer       PowerShell 3.0 and above, use CIM cmdlet which perform the  
                                                 verName.ps       same tasks as the WMI cmdlets. The CIM cmdlets comply with  
                                                 1                WS-Management (WSMan) standards and with the Common         
...
PSPossibleIncorrectComparisonWithNu Warning      Get-SqlReg 108   $null should be on the left side of equality comparisons.   
ll                                               isteredSer                                                                   
                                                 verName.ps                                                                   
                                                 1                                                                            
PSPossibleIncorrectComparisonWithNu Warning      Get-SqlReg 168   $null should be on the left side of equality comparisons.   
ll                                               isteredSer                                                                   
                                                 verName.ps                                                                   
                                                 1                                                                            
