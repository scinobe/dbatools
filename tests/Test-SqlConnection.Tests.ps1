...
--------                            --------     --------   ----  -------                                                     
PSShouldProcess                     Warning      Test-SqlCo 1     'Test-SqlConnection' calls ShouldProcess/ShouldContinue but 
                                                 nnection.p       does not have the ShouldProcess attribute.                  
                                                 s1                                                                           
PSPossibleIncorrectComparisonWithNu Warning      Test-SqlCo 101   $null should be on the left side of equality comparisons.   
ll                                               nnection.p                                                                   
                                                 s1                                                                           
PSAvoidUsingWMICmdlet               Warning      Test-SqlCo 128   File 'Test-SqlConnection.ps1' uses WMI cmdlet. For          
                                                 nnection.p       PowerShell 3.0 and above, use CIM cmdlet which perform the  
                                                 s1               same tasks as the WMI cmdlets. The CIM cmdlets comply with  
...
PSPossibleIncorrectComparisonWithNu Warning      Test-SqlCo 129   $null should be on the left side of equality comparisons.   
ll                                               nnection.p                                                                   
                                                 s1    
