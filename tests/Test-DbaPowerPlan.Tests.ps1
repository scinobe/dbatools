...
--------                            --------     --------   ----  -------                                                     
PSAvoidUsingCmdletAliases           Warning      Test-DbaPo 94    'select' is an alias of 'Select-Object'. Alias can          
                                                 werPlan.ps       introduce possible problems and make scripts hard to        
                                                 1                maintain. Please consider changing alias to its full        
                                                                  content.                                                    
PSAvoidUsingCmdletAliases           Warning      Test-DbaPo 95    'where' is an alias of 'Where-Object'. Alias can introduce  
                                                 werPlan.ps       possible problems and make scripts hard to maintain. Please 
                                                 1                consider changing alias to its full content.                
PSAvoidUsingCmdletAliases           Warning      Test-DbaPo 95    'select' is an alias of 'Select-Object'. Alias can          
                                                 werPlan.ps       introduce possible problems and make scripts hard to        
                                                 1                maintain. Please consider changing alias to its full        
                                                                  content.                                                    
PSAvoidUsingCmdletAliases           Warning      Test-DbaPo 101   'where' is an alias of 'Where-Object'. Alias can introduce  
                                                 werPlan.ps       possible problems and make scripts hard to maintain. Please 
                                                 1                consider changing alias to its full content.                
PSAvoidUsingCmdletAliases           Warning      Test-DbaPo 105   'where' is an alias of 'Where-Object'. Alias can introduce  
                                                 werPlan.ps       possible problems and make scripts hard to maintain. Please 
                                                 1                consider changing alias to its full content.                
PSPossibleIncorrectComparisonWithNu Warning      Test-DbaPo 106   $null should be on the left side of equality comparisons.   
ll                                               werPlan.ps                                                                   
                                                 1                                                                            
PSPossibleIncorrectComparisonWithNu Warning      Test-DbaPo 106   $null should be on the left side of equality comparisons.   
ll                                               werPlan.ps                                                                   
                                                 1                                                                            
PSPossibleIncorrectComparisonWithNu Warning      Test-DbaPo 120   $null should be on the left side of equality comparisons.   
ll                                               werPlan.ps                                                                   
                                                 1                                                                            
PSPossibleIncorrectComparisonWithNu Warning      Test-DbaPo 120   $null should be on the left side of equality comparisons.   
ll                                               werPlan.ps                                                                   
                                                 1                                                                            
PSUseOutputTypeCorrectly            Information  Test-DbaPo 185   The cmdlet 'Test-DbaPowerPlan' returns an object of type    
                                                 werPlan.ps       'System.Collections.ArrayList' but this type is not         
                                                 1                declared in the OutputType attribute.    
