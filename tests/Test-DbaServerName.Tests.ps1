...
--------                            --------     --------   ----  -------                                                     
PSUsePSCredentialType               Warning      Test-DbaSe 1     The Credential parameter in 'Test-DbaServerName' must be of 
                                                 rverName.p       type PSCredential. For PowerShell 4.0 and earlier, please   
                                                 s1               define a credential transformation attribute, e.g.          
                                                                  [System.Management.Automation.Credential()], after the      
                                                                  PSCredential type attribute.                                
PSUseOutputTypeCorrectly            Information  Test-DbaSe 220   The cmdlet 'Test-DbaServerName' returns an object of type   
                                                 rverName.p       'System.Collections.ArrayList' but this type is not         
                                                 s1               declared in the OutputType attribute. 
