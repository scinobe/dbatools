...
--------                            --------     --------   ----  -------                                                     
PSUseDeclaredVarsMoreThanAssigments Warning      Show-SqlDa 170   The variable 'databaseParent' is assigned but never used.   
                                                 tabaseList                                                                   
                                                 .ps1                                                                         
PSAvoidUsingPlainTextForPassword    Warning      Show-SqlDa 65    Parameter '$SqlCredential' should use SecureString,         
                                                 tabaseList       otherwise this will expose sensitive information. See       
