...
--------                            --------     --------   ----  -------                                                     
PSAvoidUsingPlainTextForPassword    Warning      Test-DbaFu 68    Parameter '$SqlCredential' should use SecureString,         
                                                 llRecovery       otherwise this will expose sensitive information. See       
                                                 Model.ps1        ConvertTo-SecureString for more information.                
PSUseOutputTypeCorrectly            Information  Test-DbaFu 162   The cmdlet 'Test-DbaFullRecoveryModel' returns an object of 
                                                 llRecovery       type 'System.Collections.ArrayList' but this type is not    
                                                 Model.ps1        declared in the OutputType attribute.
