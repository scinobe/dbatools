...
--------                            --------     --------   ----  -------                                                     
PSUseShouldProcessForStateChangingF Warning      Update-dba 1     Function ’Update-dbatools’ has verb that could change       
unctions                                         tools.ps1        system state. Therefore, the function has to support        
                                                                  'ShouldProcess'.                                            
PSUseSingularNouns                  Warning      Update-dba 1     The cmdlet 'Update-dbatools' uses a plural noun. A singular 
                                                 tools.ps1        noun should be used instead.                                
PSAvoidUsingInvokeExpression        Warning      Update-dba 11    Invoke-Expression is used. Please remove Invoke-Expression  
                                                 tools.ps1        from script and find other options instead.           
