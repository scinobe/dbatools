...
--------                            --------     --------   ----  -------                                                     
PSUseOutputTypeCorrectly            Information  Test-DbaCo 125   The cmdlet 'Test-DbaConnectionAuthScheme' returns an object 
                                                 nnectionAu       of type 'System.Collections.ArrayList' but this type is not 
                                                 thScheme.p       declared in the OutputType attribute.                       
                                                 s1                                                                           
PSUsePSCredentialType               Warning      Test-DbaCo 1     The Credential parameter in 'Test-DbaConnectionAuthScheme'  
                                                 nnectionAu       must be of type PSCredential. For PowerShell 4.0 and        
                                                 thScheme.p       earlier, please define a credential transformation          
                                                 s1               attribute, e.g.                                             
