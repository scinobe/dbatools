...
--------                            --------     --------   ----  -------                                                     
PSUseOutputTypeCorrectly            Information  Test-DbaDa 132   The cmdlet 'Test-DbaDatabaseCollation' returns an object of 
                                                 tabaseColl       type 'System.Collections.ArrayList' but this type is not    
                                                 ation.ps1        declared in the OutputType attribute.                       
PSUsePSCredentialType               Warning      Test-DbaDa 1     The Credential parameter in 'Test-DbaDatabaseCollation'     
                                                 tabaseColl       must be of type PSCredential. For PowerShell 4.0 and        
                                                 ation.ps1        earlier, please define a credential transformation          
                                                                  attribute, e.g.                                             
