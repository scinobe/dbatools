...
--------                            --------     --------   ----  -------                                                     
PSAvoidUsingPlainTextForPassword    Warning      Test-DbaJo 70    Parameter '$SqlCredential' should use SecureString,         
                                                 bOwner.ps1       otherwise this will expose sensitive information. See       
                                                                  ConvertTo-SecureString for more information.                
PSUseOutputTypeCorrectly            Information  Test-DbaJo 162   The cmdlet 'Test-DbaJobOwner' returns an object of type     
                                                 bOwner.ps1       'System.Object[]' but this type is not declared in the      
