...
--------                            --------     --------   ----  -------                                                     
PSPossibleIncorrectComparisonWithNu Warning      Copy-SqlEx 97    $null should be on the left side of equality comparisons.   
ll                                               tendedEven                                                                   
                                                 t.ps1                                                                        
PSPossibleIncorrectComparisonWithNu Warning      Copy-SqlEx 133   $null should be on the left side of equality comparisons.   
ll                                               tendedEven                                                                   
                                                 t.ps1                                                                        
