...
--------                            --------     --------   ----  -------                                                     
PSPossibleIncorrectComparisonWithNu Warning      Watch-SqlD 116   $null should be on the left side of equality comparisons.   
ll                                               bLogin.ps1                                                                   
PSPossibleIncorrectComparisonWithNu Warning      Watch-SqlD 152   $null should be on the left side of equality comparisons.   
ll                                               bLogin.ps1                                                                   
PSAvoidUsingCmdletAliases           Warning      Watch-SqlD 189   'Select' is an alias of 'Select-Object'. Alias can          
                                                 bLogin.ps1       introduce possible problems and make scripts hard to        
