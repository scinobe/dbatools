...
--------                            --------     --------   ----  -------                                                     
PSAvoidUsingPlainTextForPassword    Warning      Test-DbaDi 71    Parameter '$SqlCredential' should use SecureString,         
                                                 skAllocati       otherwise this will expose sensitive information. See       
                                                 on.ps1           ConvertTo-SecureString for more information.                
PSAvoidUsingWMICmdlet               Warning      Test-DbaDi 97    File 'Test-DbaDiskAllocation.ps1' uses WMI cmdlet. For      
                                                 skAllocati       PowerShell 3.0 and above, use CIM cmdlet which perform the  
                                                 on.ps1           same tasks as the WMI cmdlets. The CIM cmdlets comply with  
...
PSPossibleIncorrectComparisonWithNu Warning      Test-DbaDi 226   $null should be on the left side of equality comparisons.   
ll                                               skAllocati                                                                   
                                                 on.ps1                                                                       
PSUseOutputTypeCorrectly            Information  Test-DbaDi 248   The cmdlet 'Test-DbaDiskAllocation' returns an object of    
                                                 skAllocati       type 'System.Collections.ArrayList' but this type is not    
                                                 on.ps1           declared in the OutputType attribute.                       
PSUseOutputTypeCorrectly            Information  Test-DbaDi 273   The cmdlet 'Test-DbaDiskAllocation' returns an object of    
                                                 skAllocati       type 'System.Boolean' but this type is not declared in the  
                                                 on.ps1           OutputType attribute. 
