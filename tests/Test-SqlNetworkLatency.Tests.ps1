...
--------                            --------     --------   ----  -------                                                     
PSShouldProcess                     Warning      Test-SqlNe 1     'Test-SqlNetworkLatency' has the ShouldProcess attribute    
                                                 tworkLaten       but does not call ShouldProcess/ShouldContinue.             
                                                 cy.ps1                                                                       
PSAvoidUsingPlainTextForPassword    Warning      Test-SqlNe 82    Parameter '$SqlCredential' should use SecureString,         
                                                 tworkLaten       otherwise this will expose sensitive information. See       
                                                 cy.ps1           ConvertTo-SecureString for more information.                
PSUseDeclaredVarsMoreThanAssignment Warning      Test-SqlNe 109   The variable 'singleresult' is assigned but never used.     
s                                                tworkLaten                                                                   
                                                 cy.ps1                                                                       
PSUseOutputTypeCorrectly            Information  Test-SqlNe 143   The cmdlet 'Test-SqlNetworkLatency' returns an object of    
                                                 tworkLaten       type 'System.Object[]' but this type is not declared in the 
                                                 cy.ps1           OutputType attribute.                                       
