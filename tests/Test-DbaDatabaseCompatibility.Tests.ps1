...
--------                            --------     --------   ----  -------                                                     
PSUseOutputTypeCorrectly            Information  Test-DbaDa 133   The cmdlet 'Test-DbaDatabaseCompatibility' returns an       
                                                 tabaseComp       object of type 'System.Collections.ArrayList' but this type 
                                                 atibility.       is not declared in the OutputType attribute.                
                                                 ps1                                                                          
PSUsePSCredentialType               Warning      Test-DbaDa 1     The Credential parameter in 'Test-DbaDatabaseCompatibility' 
                                                 tabaseComp       must be of type PSCredential. For PowerShell 4.0 and        
                                                 atibility.       earlier, please define a credential transformation          
                                                 ps1              attribute, e.g.                                             
