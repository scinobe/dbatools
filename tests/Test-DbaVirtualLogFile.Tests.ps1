...
--------                            --------     --------   ----  -------                                                     
PSUseOutputTypeCorrectly            Information  Test-DbaVi 173   The cmdlet 'Test-DbaVirtualLogFile' returns an object of    
                                                 rtualLogFi       type 'System.Collections.ArrayList' but this type is not    
                                                 le.ps1           declared in the OutputType attribute. 
