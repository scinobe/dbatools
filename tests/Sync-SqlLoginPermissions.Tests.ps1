...
Entire test commented out because someone needs to look at numerous results from the Script Analyzer.

Logged as issue #387, take a look there for more detail.
