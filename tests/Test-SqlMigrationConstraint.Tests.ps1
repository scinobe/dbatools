...
--------                            --------     --------   ----  -------                                                     
PSShouldProcess                     Warning      Test-SqlMi 1     'Test-SqlMigrationConstraint' has the ShouldProcess         
                                                 grationCon       attribute but does not call ShouldProcess/ShouldContinue.   
                                                 straint.ps                                                                   
                                                 1                                                                            
PSAvoidUsingWriteHost               Warning      Test-SqlMi 183   File 'Test-SqlMigrationConstraint.ps1' uses Write-Host.     
                                                 grationCon       Avoid using Write-Host because it might not work in all     
                                                 straint.ps       hosts, does not work when there is no host, and (prior to   
                                                 1                PS 5.0) cannot be suppressed, captured, or redirected.      
                                                                  Instead, use Write-Output, Write-Verbose, or                
                                                                  Write-Information.                                          
PSAvoidUsingWriteHost               Warning      Test-SqlMi 237   File 'Test-SqlMigrationConstraint.ps1' uses Write-Host.     
                                                 grationCon       Avoid using Write-Host because it might not work in all     
                                                 straint.ps       hosts, does not work when there is no host, and (prior to   
                                                 1                PS 5.0) cannot be suppressed, captured, or redirected.      
                                                                  Instead, use Write-Output, Write-Verbose, or                
